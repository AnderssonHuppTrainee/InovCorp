        ...
        <div class="space-y-6 p-4">
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <!-- Paginação -->
                    <div
                        v-if="archives.data.length > 0"
                        class="flex items-center justify-between px-2 py-4"
                    >
                        <div class="text-sm text-muted-foreground">
                            Mostrando
                            <strong>{{ archives.from }}</strong>
                            a
                            <strong>{{ archives.to }}</strong>
                            de
                            <strong>{{ archives.total }}</strong>
                            resultados
                        </div>
                        ...
                        <div class="flex items-center space-x-2">
                            <Button
                                ...
                                @click="goToPage(archives.current_page - 1)"
                            >
...
const applyFilters = () => {
    ...
    if (documentTypeFilter.value && documentTypeFilter.value !== 'all')
        params.document_type = documentTypeFilter.value;
    if (visibilityFilter.value && visibilityFilter.value !== 'all')
        params.is_public = visibilityFilter.value;

    router.get('/digital-archive', params, {
        preserveState: true,
        preserveScroll: true,
    });
};
